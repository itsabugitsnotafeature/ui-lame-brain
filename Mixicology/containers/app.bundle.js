...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BgVideo = __webpack_require__(168);

	var _BgVideo2 = _interopRequireDefault(_BgVideo);
	  ...
	  _createClass(World, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_BgVideo2.default, null)
	      );
	    }
	  }]);
	...
	_reactDom2.default.render(_react2.default.createElement(World, null), document.getElementById('mixicology-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BgVideo = function (_React$Component) {
		_inherits(BgVideo, _React$Component);

		function BgVideo() {
			_classCallCheck(this, BgVideo);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(BgVideo).apply(this, arguments));
		}

		_createClass(BgVideo, [{
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					"div",
					...
					_react2.default.createElement(
						"video",
						{ autoplay: true, poster: "./styles/imgs/vid-poster.png", loop: true },
						_react2.default.createElement("source", { src: "./styles/videos/bg-vid.mp4" })
					)
				);
			}
		}]);
